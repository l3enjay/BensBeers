...
namespace BensBeers.Data.Migrations
{
    ...
    [Migration("20181201230029_RemovingQuantities")]
    partial class RemovingQuantities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BensBeers.Data.Entities.BensBeersUser", b =>
                {
            ...
            modelBuilder.Entity("BensBeers.Data.Entities.Order", b =>
                {
                    b.HasOne("BensBeers.Data.Entities.BensBeersUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BensBeers.Data.Entities.BensBeersUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
